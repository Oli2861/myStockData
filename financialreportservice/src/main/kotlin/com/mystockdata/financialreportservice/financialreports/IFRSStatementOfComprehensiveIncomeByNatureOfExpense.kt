...
private val keyLambdaMap = mapOf<String, (IFRSStatementOfComprehensiveIncomeByNatureOfExpense, Item) -> Unit>(
    ...
    "ifrs-full:ChangesInInventoriesOfFinishedGoodsAndWorkInProgress" to { statement, item -> statement.ifrs_full_ChangesInInventoriesOfFinishedGoodsAndWorkInProgress = item.valueNumeric},
    "ifrs-full:OtherWorkPerformedByEntityAndCapitalised" to { statement, item -> statement.ifrs_full_OtherWorkPerformedByEntityAndCapitalised = item.valueNumeric},
    "ifrs-full:RawMaterialsAndConsumablesUsed" to { statement, item -> statement.ifrs_full_RawMaterialsAndConsumablesUsed = item.valueNumeric},
    "ifrs-full:EmployeeBenefitsExpense" to { statement, item -> statement.ifrs_full_EmployeeBenefitsExpense = item.valueNumeric},
    "ifrs-full:DepreciationAndAmortisationExpense" to { statement, item -> statement.ifrs_full_DepreciationAndAmortisationExpense = item.valueNumeric},
    "ifrs-full:ImpairmentLossReversalOfImpairmentLossRecognisedInProfitOrLoss" to { statement, item -> statement.ifrs_full_ImpairmentLossReversalOfImpairmentLossRecognisedInProfitOrLoss = item.valueNumeric},
    "ifrs-full:OtherExpenseByNature" to { statement, item -> statement.ifrs_full_OtherExpenseByNature = item.valueNumeric},
