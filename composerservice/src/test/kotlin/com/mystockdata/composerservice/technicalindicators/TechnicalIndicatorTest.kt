...
class TechnicalIndicatorTest {
    ...
    fun smaForMultipleSymbolsTest(){
        ...
        val expectedList = listOf(
            ...
            listOf(
                TechnicalIndicator(data[18].time, symbol2, IndicatorName.SMA, BigDecimal(214.64, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[19].time, symbol2, IndicatorName.SMA, BigDecimal(208.93, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[20].time, symbol2, IndicatorName.SMA, BigDecimal(209.29, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[21].time, symbol2, IndicatorName.SMA, BigDecimal(201.43, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[22].time, symbol2, IndicatorName.SMA, BigDecimal(201.07, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[23].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[24].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[25].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[26].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[27].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[28].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[29].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[30].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[31].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[32].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[33].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[34].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros()),
                TechnicalIndicator(data[35].time, symbol2, IndicatorName.SMA, BigDecimal(0, MathContext.DECIMAL32).stripTrailingZeros())
            )
        )
